...
/*		command.append(" -sharpen 1 -resize ");
		command.append(requiredWidth);
		command.append("x");
		command.append(requiredHeight);
		...
		command.append("x");
		command.append(requiredHeight);
		command.append(" -gravity center  ");*/
		 
		command.append(srcFile);
		command.append(" ");
		command.append(destFile);
		
		logger.info("ImageMagic cmd:" + command.toString());
		logger.warn("ImageMagic cmd:" + command.toString());
		try {
...
//				process.waitFor();
	...
	@Override
	public void scaleImagePNG(String srcFile, String destFile, int requiredWidth, int requiredHeight, int padding) {
