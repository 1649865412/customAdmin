...
<cartmatic:swf_upload btnPlaceHolderId="skuImgBtnPlaceHolderId" uploadCategory="product" uploadFileTypes="*.jpg; *.png; *.gif" previewImg="productImage" objId="${product.productId}" previewSize="b" fileInputId="image" button_text="上传图片"></cartmatic:swf_upload>
